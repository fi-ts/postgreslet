...
func (p *Postgres) ToUnstructuredZalandoPostgresql(z *zalando.Postgresql, c *corev1.ConfigMap, s string) (*unstructured.Unstructured, error) {
	if z == nil {
