...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodTopologySpreadConstraintsOpts) DeepCopyInto(out *PodTopologySpreadConstraintsOpts) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodTopologySpreadConstraintsOpts.
func (in *PodTopologySpreadConstraintsOpts) DeepCopy() *PodTopologySpreadConstraintsOpts {
	if in == nil {
		return nil
	}
	out := new(PodTopologySpreadConstraintsOpts)
	in.DeepCopyInto(out)
	return out
}
