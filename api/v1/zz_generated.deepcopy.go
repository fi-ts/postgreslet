...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LBSocket) DeepCopyInto(out *LBSocket) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LBSocket.
func (in *LBSocket) DeepCopy() *LBSocket {
	if in == nil {
		return nil
	}
	out := new(LBSocket)
